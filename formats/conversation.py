...
TOPICS = [
    ...
    # Health and body
    "why we need to eat different foods",
    ...
    "why people yawn",
    "how to stay warm when it is cold outside",
    # Money and trade
    "what money is and how it works",
    "the difference between needs and wants",
    "how to trade fairly",
    "what happens when you save money",
    "how a store decides what to sell",
    "why some things cost more than others",
    # Problem solving
    "figuring out what to do when plans change",
    "how to deal with a bully",
    "what to do when two friends disagree",
    "how to ask for help when you need it",
    "what to do when you are bored",
    "how to calm down when you are upset",
    # Time and change
    "what it was like a long time ago",
    "how things change as you grow up",
    "why some things take a long time",
    "what it means to be patient",
    "how the world looks different in each season",
    "what happens to old buildings over time",
    # Community and rules
    "why we have rules",
    "what a leader does",
    "how people work together to build things",
    "why voting is important",
    "what a library is for",
    "how a town gets clean water",
    # Food and cooking
    "where bread comes from",
    "how milk gets from a cow to your cup",
    "why we cook food before eating it",
    "what grows in different parts of the world",
    "how to pick ripe fruit",
    "why some people eat different foods",
    # Transportation
    "how a boat floats on water",
    "what makes a car go",
    "how a train follows the tracks",
    "why airplanes can fly",
    "how people traveled before cars",
    "riding a bicycle for the first time",
    # Music and art
    "how to clap a rhythm",
    "why people sing songs",
    "how to draw a face",
    "what colors you can mix together",
    "making music with things around the house",
    "why some songs make you feel happy or sad",
    # Safety
    "what to do if there is a fire",
    "how to cross the street safely",
    "why you should not talk to strangers alone",
    "what to do if you get separated from your family",
    "how to be safe around animals you do not know",
